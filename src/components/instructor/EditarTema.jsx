...
<div>
    <div className="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      <p className="lead">What do you want to change? (if only the name you can change it in any of them)</p>
    </div>
    ...
    <SubirTextoContainer courseId={courseId} sectionId={sectionId} history={history} topicId={topicId} topic={topic}/> 
    <SubirArchivosContainer courseId={courseId} sectionId={sectionId} history={history} topicId={topicId} topic={topic}/> 
  <SubirVideoContainer courseId={courseId} sectionId={sectionId} history={history} topicId={topicId} topic={topic}/>
  </div>
);
